"""
Django settings for teloenvioproject project.
...
SECRET_KEY = 'django-insecure-+w-y3e3ret-32)@kdor66_-e&fxlz%c-qqnlk*+a)l^%=5r5rq'
...
ROOT_URLCONF = 'teloenvioproject.urls'
...
WSGI_APPLICATION = 'teloenvioproject.wsgi.application'
...
# Media folder: imágenes productos
MEDIA_URL = '/media/'
